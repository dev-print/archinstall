...
class GlobalMenu(AbstractMenu):
	def __init__(self, data_store: dict[str, Any]):
		...
		if 'Catinstall-language' not in data_store:
			data_store['Catinstall-language'] = translation_handler.get_language_by_abbr('en')
